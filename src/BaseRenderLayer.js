...
class BaseRenderLayer extends Lifecycle_1.Disposable {
    ...
    _drawChars(cell, x, y) {
        ...
        if (this._bitmapGenerator[glyph.texturePage] && this._charAtlas.pages[glyph.texturePage].canvas !== this._bitmapGenerator[glyph.texturePage].canvas) {
            (_b = (_a = this._bitmapGenerator[glyph.texturePage]) === null || _a === void 0 ? void 0 : _a.bitmap) === null || _b === void 0 ? void 0 : _b.close();
            delete this._bitmapGenerator[glyph.texturePage];
        }
        if (this._charAtlas.pages[glyph.texturePage].version !== ((_c = this._bitmapGenerator[glyph.texturePage]) === null || _c === void 0 ? void 0 : _c.version)) {
        ...
        this._ctx.drawImage(((_d = this._bitmapGenerator[glyph.texturePage]) === null || _d === void 0 ? void 0 : _d.bitmap) || this._charAtlas.pages[glyph.texturePage].canvas, glyph.texturePosition.x, glyph.texturePosition.y, glyph.size.x, glyph.size.y, x * this._deviceCellWidth + this._deviceCharLeft - glyph.offset.x, y * this._deviceCellHeight + this._deviceCharTop - glyph.offset.y, glyph.size.x, glyph.size.y);
        this._ctx.restore();
    }
    _clipRow(y) {
        this._ctx.beginPath();
...
class BitmapGenerator {
    ...
    refresh() {
        var _a;
        (_a = this._bitmap) === null || _a === void 0 ? void 0 : _a.close();
        this._bitmap = undefined;
